...
//    }
    ...
    @GetMapping("/customers")
    public ModelAndView getProduct(@RequestParam(value = "page", defaultValue = "0") int page) throws Exception {
        int pageSize = 3;
        Page<Customer> customers = customerService.findAllpage(page,pageSize);
        ModelAndView modelAndView = new ModelAndView("/customer/list");
        modelAndView.addObject("customers", customers);
        return modelAndView;
    }
